...
export class ReminderInfo{
	...
	static getModeValueText(reminder){
		switch(reminder.mode){
			...
			case 5: return `${reminder.value}月前`;
		}
	}
...
export function getRuleText(task){
	...
	if(task.custom==null)
	{
		...
		case 1: res +=`每${innerStr}天`;break;
		case 2: res +=`每${innerStr}周`;break;
		case 3: res +=`每${innerStr}个月`;break;
		case 4: res +=`每${innerStr}年`;break;
	   }   
	}
	else{
...
export const persistDays = [
	new KeyValueText(-1,0,"永远"),new KeyValueText(7,1,"7天"),new KeyValueText(30,2,"30天"),new KeyValueText(100,3,"100天"),
