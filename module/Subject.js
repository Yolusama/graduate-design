...
export const subjects = {
	...
	"lightcyan": new SubjectStyle("lightcyan", "#111", "rgb(0,75,125)", "rgb(0,105,235)", "darkcyan", "fuchsia"),
	...
	"orangered":new SubjectStyle("orangered", "#eee", "rgb(0,75,225)", "rgb(0,105,235)", "orange", "#3f3"),
	...
	"tomato": new SubjectStyle("tomato", "#ffe", "#123", "rgb(0,125,225)", "crimson", "#fc2"),
	...
	"thistle": new SubjectStyle("thistle", "#011", "cornflowerblue", "rgb(0,75,205)", "#DCBBFF", "royalblue"),
	"springgreen": new SubjectStyle("springgreen", "#fef", "#fff", "rgb(0,125,225)", "#fd3", "#6dc"),
	"goldenrod": new SubjectStyle("goldenrod", "#112", "yellow", "rgb(0,125,225)", "sandybrown", "coral"),
}
